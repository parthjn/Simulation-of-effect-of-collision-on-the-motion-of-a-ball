...
public class SliderPanel extends JPanel{
    ...
    private cueL al;
    private int count=0;
    private RestitutionHEightListener restitutionListener;
    public SliderPanel() {
        ...
        pause.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				al.start();
                if(restitutionListener.gett()>=10) {
                    if (restitutionListener != null) {
                        restitutionListener.getRestitutionHeight(Double.parseDouble(e.getText()), Integer.parseInt(h.getText()));
                        restitutionListener.show();
                    }
                }
			}
    ...
    public void setRestitutionListener(RestitutionHEightListener restitutionListener)
    {
        this.restitutionListener=restitutionListener;
    }
